...
import { a as AWS_REGION_FULL, l as Button, m as cn, r as Route$2 } from "./_ssr/router-Bg95u4OA.mjs";
...
import { t as ArchitectureBadge } from "./_ssr/architecture-badge-no06e0ju.mjs";
import { n as StatusBadge, r as jobStatusTone, t as StageIcon } from "./_ssr/status-badge-Z54TO3dD.mjs";
import { a as RuntimeCard, c as errorCopy, i as LiveDeployment, l as useJob, n as BedrockReasoning, r as CostComparison, s as deriveStages, t as ArchitectureCard } from "./_ssr/use-job-ADXQZ7Ul.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_jobId-GTM2GlAg.js
...
function BuildLogs({ logs }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "overflow-hidden rounded-lg bg-background-deep shadow-border",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				className: "ml-2 font-mono text-2xs text-subtle",
				children: [logs.length, " lines"]
			})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: cn("size-4 text-subtle transition-transform", open && "rotate-180") })]
		}), open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "terminal-scroll max-h-72 overflow-auto border-t border-border px-4 py-3 font-mono text-2xs leading-6",
			children: logs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-subtle",
				children: "Waiting for log stream from the control plane."
			}) : logs.map((line, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: tone(line.level),
				children: [line.timestamp ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "text-subtle",
					children: [
						"[",
						line.timestamp,
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
					...
					value: job.decisionSource === "deterministic" ? "Deterministic scanner" : job.decisionSource === "bedrock" ? "Amazon Bedrock" : job.decisionSource === "policy" ? "Deployment policy" : "—"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-2xs tracking-wide text-subtle uppercase",
					children: "Runtime"
			...
			children: [
				...
				job ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeploymentTimeline, { stages: deriveStages(job) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex flex-col gap-4",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArchitectureCard, { job }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BuildLogs, { logs: job.logs })
				] }) : null
			]
		})
	});
