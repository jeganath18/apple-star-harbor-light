...
import { a as AWS_REGION_FULL, c as POLL_INTERVAL_MS, l as Button } from "./router-Dd4e0Vxu.mjs";
import { t as ArchitectureBadge } from "./architecture-badge-Cmr4BUuw.mjs";
import { i as fetchJob } from "./app-shell-BKzqlqf6.mjs";
import { a as formatUsd, t as confidenceLabel } from "./format-D-zwO8bu.mjs";
import { n as StatusBadge } from "./status-badge-TLtOGgl3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/use-job-Cmxk5Paw.js
...
function CostComparison({ job }) {
	...
	const actualLabel = cost?.actualLabel ?? (job?.qemu?.present ? "Graviton + QEMU" : "ARM64 Fargate");
	const comparisonLabel = cost?.comparisonLabel ?? (job?.qemu?.present ? "Equivalent X86 EC2" : "X86 Fargate");
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "rounded-lg bg-card p-4 shadow-border",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: formatUsd(cost?.arm64MonthlyUsd)
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: formatUsd(cost?.x86MonthlyUsd)
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-2xs text-subtle",
							children: "/ month"
			...
			cost?.estimatedSavingsPercent !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "mt-4 font-mono text-sm text-infra",
				children: [
					"Estimated difference ",
					formatUsd(cost?.estimatedSavingsUsd),
					cost?.estimatedSavingsPercent !== void 0 ? ` · ${Math.round(cost?.estimatedSavingsPercent)}%` : ""
				]
			}) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
