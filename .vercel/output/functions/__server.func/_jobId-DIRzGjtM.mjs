...
import { l as Button, m as cn, n as Route } from "./_ssr/router-Dd4e0Vxu.mjs";
...
import { n as StatusBadge, r as jobStatusTone } from "./_ssr/status-badge-TLtOGgl3.mjs";
import { a as RuntimeCard, i as LiveDeployment, l as useJob, n as BedrockReasoning, o as architecturePath, r as CostComparison, t as ArchitectureCard } from "./_ssr/use-job-Cmxk5Paw.mjs";
import { t as ErrorState } from "./_ssr/error-state-BcJABxoJ.mjs";
import { t as Skeleton } from "./_ssr/skeleton-ByubNcEx.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_jobId-DIRzGjtM.js
			...
			children: [
				...
				job ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReportSection, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item, {
									k: "Source",
									v: job.raw.report.decision.source === "deterministic" ? "Deterministic Scanner" : job.decisionSource === "bedrock" ? "Amazon Bedrock" : job.decisionSource
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item, {
									k: "Build",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReportSection, {
						...
						children: job?.raw?.report?.scanner?.confidence ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
							className: "space-y-1.5 font-mono text-xs text-muted",
							children: [
								job.raw?.report?.scanner?.verdict ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Verdict: ", job.raw?.report?.scanner?.verdict] }) : null,
								job?.raw?.report?.scanner?.docker?.baseImages?.image ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Framework: ", job?.raw?.report?.scanner?.docker?.baseImages?.image] }) : null,
