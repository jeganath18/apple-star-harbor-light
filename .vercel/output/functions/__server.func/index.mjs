...
var grokOgIdentity = { "site": {
	...
	"type": "website",
	"card": "custom",
	"description": "Deploy anywhere. Run on the architecture that makes sense.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_zA1O8l = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_zA1O8l
	};
	return ((_m, p) => {
		return {
			data,
